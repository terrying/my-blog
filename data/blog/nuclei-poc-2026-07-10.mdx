---
title: 'Nuclei POC 精选分析 - 2026-07-10'
date: '2026-07-10'
tags: ['Nuclei', 'POC分析', '漏洞扫描', '威胁情报']
draft: false
summary: '从 302 个模板更新中精选分析 13 个高价值 POC，发现 10 个高风险漏洞'
authors: ['default']
category: 'security-intel'
---

# Nuclei POC 精选分析 - 2026-07-10
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.142 (percentile 0.96151) @ 2026-07-09
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.02803 (percentile 0.84792) @ 2026-07-09
...
- **影响资产**: GitLab 平台
- **预估影响**: 数千个
- **EPSS**: 0.19506 (percentile 0.97047) @ 2026-07-09
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.29434 (percentile 0.97957) @ 2026-07-09
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.2903 (percentile 0.97932) @ 2026-07-09
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.88496 (percentile 0.99754) @ 2026-07-09
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.99301 (percentile 0.99934) @ 2026-07-09
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.01531 (percentile 0.71769) @ 2026-07-09
...
- **影响资产**: WordPress 站点
- **预估影响**: 数千万个
- **EPSS**: 0.03578 (percentile 0.88015) @ 2026-07-09
...
```bash
# 扫描高危漏洞
nuclei -t http/cves/2025/CVE-2025-34085.yaml -t http/cves/2026/CVE-2026-4631.yaml -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2026/CVE-2026-20182.yaml -t headless/cves/2025/CVE-2025-29927-HEADLESS.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -u target-url
