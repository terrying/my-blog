---
title: 'Nuclei POC 精选分析 - 2026-09-06'
date: '2026-09-06'
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.02581 (percentile 0.84137) @ 2026-09-05
...
- **影响资产**: GitLab 平台
- **预估影响**: 数千个
- **EPSS**: 0.2026 (percentile 0.97349) @ 2026-09-05
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.59417 (percentile 0.99082) @ 2026-09-05
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.94709 (percentile 0.99852) @ 2026-09-05
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.34885 (percentile 0.98366) @ 2026-09-05
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.31362 (percentile 0.98203) @ 2026-09-05
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.913 (percentile 0.99805) @ 2026-09-05
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.91522 (percentile 0.99808) @ 2026-09-05
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.97878 (percentile 0.99904) @ 2026-09-05
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.01647 (percentile 0.74514) @ 2026-09-05
...
- **影响资产**: WordPress 站点
- **预估影响**: 数千万个
- **EPSS**: 0.03578 (percentile 0.88644) @ 2026-09-05
...
```bash
# 扫描高危漏洞
nuclei -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-54309.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2025/CVE-2025-9242.yaml -t code/cves/2026/CVE-2026-20182.yaml -t code/cves/2026/CVE-2026-24061.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -u target-url

# 扫描所有今日新增模板  
nuclei -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-54309.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2025/CVE-2025-9242.yaml -t code/cves/2026/CVE-2026-20182.yaml -t code/cves/2026/CVE-2026-24061.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -t headless/cves/2025/CVE-2025-24752.yaml -t headless/cves/2025/CVE-2025-25062.yaml -t headless/cves/2025/CVE-2025-8191.yaml -u target-url
```
