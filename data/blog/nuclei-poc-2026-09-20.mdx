---
title: 'Nuclei POC 精选分析 - 2026-09-20'
date: '2026-09-20'
tags: ['Nuclei', 'POC分析', '漏洞扫描', '威胁情报']
draft: false
summary: '从 606 个模板更新中精选分析 22 个高价值 POC，发现 16 个高风险漏洞'
authors: ['default']
category: 'security-intel'
---

# Nuclei POC 精选分析 - 2026-09-20
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.02747 (percentile 0.8553) @ 2026-09-19
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.02626 (percentile 0.84808) @ 2026-09-19
...
- **影响资产**: GitLab 平台
- **预估影响**: 数千个
- **EPSS**: 0.20586 (percentile 0.97403) @ 2026-09-19
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.38527 (percentile 0.98507) @ 2026-09-19
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.31138 (percentile 0.98188) @ 2026-09-19
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.02111 (percentile 0.80971) @ 2026-09-19
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.01647 (percentile 0.7541) @ 2026-09-19
...
- **影响资产**: WordPress 站点
- **预估影响**: 数千万个
- **EPSS**: 0.03578 (percentile 0.88864) @ 2026-09-19
...
|---------|---------|------|---------|------|---------|
| Arelle &lt; 2.39.10 - Remote Code Execution | 🔴 critical | CVE漏洞 | 通用 | 0.0275 | 5/5 |
| Arelle &lt; 2.39.10 - Remote Code Execution | 🔴 critical | CVE漏洞 | 通用 | 0.0275 | 5/5 |
...
```bash
# 扫描高危漏洞
nuclei -t http/cves/2026/CVE-2026-42796.yaml -t http/cves/2026/CVE-2026-42796.yaml -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2026/CVE-2026-8467.yaml -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2026/CVE-2026-8467.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -u target-url

# 扫描所有今日新增模板  
nuclei -t http/cves/2026/CVE-2026-42796.yaml -t http/cves/2026/CVE-2026-42796.yaml -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2026/CVE-2026-8467.yaml -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2026/CVE-2026-8467.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -t headless/cves/2025/CVE-2025-24752.yaml -t headless/cves/2025/CVE-2025-25062.yaml -t headless/cves/2025/CVE-2025-8191.yaml -t headless/cves/2025/CVE-2025-24752.yaml -t headless/cves/2025/CVE-2025-25062.yaml -t headless/cves/2025/CVE-2025-8191.yaml -u target-url
```
