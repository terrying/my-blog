---
title: 'Nuclei POC 精选分析 - 2026-08-08'
date: '2026-08-08'
tags: ['Nuclei', 'POC分析', '漏洞扫描', '威胁情报']
draft: false
summary: '从 905 个模板更新中精选分析 30 个高价值 POC，发现 24 个高风险漏洞'
authors: ['default']
...
**描述**: Pre-authentication reflected XSS in WordPress wp-login.php (CVE-2026-64638).
...
**参考链接**: 
- [参考资料](https://pwn.ai/blog/xss2shell)
- [参考资料](https://thehackernews.com/2026/08/new-wordpress-pre-auth-xss-could-lead.html)
- [参考资料](https://nvd.nist.gov/vuln/detail/CVE-2026-64638)
- [参考资料](https://wordpress.org/news/2026/08/wordpress-7-0-3-release/)
