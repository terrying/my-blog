---
title: 'Nuclei POC 精选分析 - 2026-05-03'
date: '2026-05-03'
tags: ['Nuclei', 'POC分析', '漏洞扫描', '威胁情报']
draft: false
summary: '从 301 个模板更新中精选分析 14 个高价值 POC，发现 11 个高风险漏洞'
authors: ['default']
category: 'security-intel'
---

# Nuclei POC 精选分析 - 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.07973 (percentile 0.92091) @ 2026-05-02
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.53659 (percentile 0.98008) @ 2026-05-02
...
- **影响资产**: GitLab 平台
- **预估影响**: 数千个
- **EPSS**: 0.20843 (percentile 0.95637) @ 2026-05-02
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.54011 (percentile 0.98025) @ 2026-05-02
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.44456 (percentile 0.9758) @ 2026-05-02
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.77758 (percentile 0.99012) @ 2026-05-02
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.53057 (percentile 0.97978) @ 2026-05-02
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.10607 (percentile 0.93315) @ 2026-05-02
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.91812 (percentile 0.99694) @ 2026-05-02
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.92118 (percentile 0.99716) @ 2026-05-02
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.01922 (percentile 0.83455) @ 2026-05-02
...
```bash
# 扫描高危漏洞
nuclei -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-22457.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32433.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-54309.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2026/CVE-2026-24061.yaml -t headless/cves/2025/CVE-2025-29927-HEADLESS.yaml -t code/cves/2025/CVE-2025-6984.yaml -u target-url
