---
title: 'Nuclei POC 精选分析 - 2026-09-14'
date: '2026-09-14'
tags: ['Nuclei', 'POC分析', '漏洞扫描', '威胁情报']
draft: false
summary: '从 902 个模板更新中精选分析 21 个高价值 POC，发现 12 个高风险漏洞'
authors: ['default']
category: 'security-intel'
---

# Nuclei POC 精选分析 - 2026-09-14
...
- **漏洞ID**: `CVE-2026-5562`
- **CVE**: `CVE-2026-5562` (2026)
- **严重程度**: 🔴 CRITICAL
- **风险等级**: 极高风险 (5/5)
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.0062 (percentile 0.47816) @ 2026-09-13
...
**参考链接**: 
- [参考资料](https://nvd.nist.gov/vuln/detail/CVE-2026-5562)
- [参考资料](https://vuldb.com/?id.355332)
- [参考资料](https://github.com/provectus/kafka-ui)
...
**参考链接**: 
- [参考资料](https://about.gitlab.com/releases/2026/09/10/patch-release-gitlab-19-3-2-released/)
- [参考资料](https://gitlab.com/gitlab-org/gitlab/-/commit/0ff7b6b2911723389f2271b10362591b0a69a166)
- [参考资料](https://github.com/ynsmroztas/GitLabSniper)
- [参考资料](https://github.com/mhtsec/CVE-2026-85706)
- [参考资料](https://nvd.nist.gov/vuln/detail/CVE-2026-85706)
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.02626 (percentile 0.84629) @ 2026-09-13
...
- **影响资产**: GitLab 平台
- **预估影响**: 数千个
- **EPSS**: 0.20586 (percentile 0.97371) @ 2026-09-13
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.98754 (percentile 0.99924) @ 2026-09-13
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.59417 (percentile 0.99066) @ 2026-09-13
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.94709 (percentile 0.99853) @ 2026-09-13
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.38527 (percentile 0.98487) @ 2026-09-13
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.97993 (percentile 0.99907) @ 2026-09-13
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.02111 (percentile 0.80754) @ 2026-09-13
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.01647 (percentile 0.75121) @ 2026-09-13
...
- **影响资产**: WordPress 站点
- **预估影响**: 数千万个
- **EPSS**: 0.03578 (percentile 0.88728) @ 2026-09-13
...
|---------|---------|------|---------|------|---------|
| Provectus kafka-ui &lt;&#x3D;0.7.2 - Remote Code E | 🔴 critical | CVE漏洞 | 通用 | 0.0062 | 5/5 |
| GitLab CE/EE &lt;&#x3D;19.1.7/19.2.5/19.3.1 - Arbi | 🔴 critical | CVE漏洞 | GitLab 平台 | 0.0116 | 5/5 |
...
```bash
# 扫描高危漏洞
nuclei -t http/cves/2026/CVE-2026-5562.yaml -t http/cves/2026/CVE-2026-85706.yaml -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32433.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-54309.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2026/CVE-2026-24061.yaml -t code/cves/2026/CVE-2026-8467.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -u target-url

# 扫描所有今日新增模板  
nuclei -t http/cves/2026/CVE-2026-5562.yaml -t http/cves/2026/CVE-2026-85706.yaml -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32433.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-54309.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2026/CVE-2026-24061.yaml -t code/cves/2026/CVE-2026-8467.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -t headless/cves/2025/CVE-2025-24752.yaml -t headless/cves/2025/CVE-2025-25062.yaml -t headless/cves/2025/CVE-2025-8191.yaml -t headless/cves/2025/CVE-2025-24752.yaml -t headless/cves/2025/CVE-2025-25062.yaml -t headless/cves/2025/CVE-2025-8191.yaml -t headless/cves/2025/CVE-2025-24752.yaml -t headless/cves/2025/CVE-2025-25062.yaml -t headless/cves/2025/CVE-2025-8191.yaml -u target-url
```
