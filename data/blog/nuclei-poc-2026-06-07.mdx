---
title: 'Nuclei POC 精选分析 - 2026-06-07'
date: '2026-06-07'
tags: ['Nuclei', 'POC分析', '漏洞扫描', '威胁情报']
draft: false
summary: '从 300 个模板更新中精选分析 14 个高价值 POC，发现 11 个高风险漏洞'
authors: ['default']
category: 'security-intel'
---

# Nuclei POC 精选分析 - 2026-06-07
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.07973 (percentile 0.92227) @ 2026-06-06
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.58941 (percentile 0.9826) @ 2026-06-06
...
- **影响资产**: GitLab 平台
- **预估影响**: 数千个
- **EPSS**: 0.20843 (percentile 0.95734) @ 2026-06-06
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.62606 (percentile 0.984) @ 2026-06-06
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.57345 (percentile 0.98192) @ 2026-06-06
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.768 (percentile 0.98974) @ 2026-06-06
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.49839 (percentile 0.97867) @ 2026-06-06
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.06616 (percentile 0.91367) @ 2026-06-06
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.78594 (percentile 0.99064) @ 2026-06-06
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.83125 (percentile 0.9928) @ 2026-06-06
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.92118 (percentile 0.99723) @ 2026-06-06
...
```bash
# 扫描高危漏洞
nuclei -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-22457.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32433.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-54309.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2025/CVE-2025-9242.yaml -t code/cves/2026/CVE-2026-20182.yaml -t headless/cves/2025/CVE-2025-29927-HEADLESS.yaml -u target-url
