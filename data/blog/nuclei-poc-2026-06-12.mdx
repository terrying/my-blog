---
title: 'Nuclei POC 精选分析 - 2026-06-12'
date: '2026-06-12'
tags: ['Nuclei', 'POC分析', '漏洞扫描', '威胁情报']
draft: false
summary: '从 403 个模板更新中精选分析 30 个高价值 POC，发现 23 个高风险漏洞'
authors: ['default']
...
**参考链接**: 
- [参考资料](https://www.wordfence.com/threat-intel/vulnerabilities/wordpress-plugins/hippoo/hippoo-mobile-app-for-woocommerce-194-unauthenticated-authentication-bypass-to-administrator-account-takeover-via-rest-api)
- [参考资料](https://plugins.trac.wordpress.org/changeset/3557733)
...
**参考链接**: 
- [参考资料](https://github.com/thorsten/phpMyFAQ/security/advisories/GHSA-289f-fq7w-6q2w)
- [参考资料](https://www.phpmyfaq.de)
- [参考资料](http://nvd.nist.gov/vuln/detail/CVE-2026-46364)
...
**参考链接**: 
- [参考资料](https://github.com/dgraph-io/dgraph/security/advisories/GHSA-vvf7-6rmr-m29q)
- [参考资料](https://nvd.nist.gov/vuln/detail/CVE-2026-41492)
...
**参考链接**: 
- [参考资料](https://www.wordfence.com/threat-intel/vulnerabilities/id/389c0b89-e408-4ad5-9723-a16b745771f0?source=cve)
- [参考资料](https://plugins.trac.wordpress.org/browser/everest-forms/tags/3.4.3/includes/class-evf-form-task.php#L584)
- [参考资料](https://everestforms.net/changelog/)
- [参考资料](https://www.wordfence.com/blog/2026/06/attackers-actively-exploiting-critical-vulnerability-in-everest-forms-pro-plugin/)
...
**参考链接**: 
- [参考资料](https://patchstack.com/database/wordpress/plugin/woo-product-slider-pro/vulnerability/wordpress-product-slider-pro-for-woocommerce-plugin-3-5-2-backdoor-vulnerability)
- [参考资料](https://patchstack.com/articles/critical-supply-chain-compromise-in-smart-slider-3-pro-full-malware-analysis/)
- [参考资料](https://nvd.nist.gov/vuln/detail/CVE-2026-49777)
...
**参考链接**: 
- [参考资料](https://github.com/siyuan-note/siyuan/security/advisories/GHSA-hhgj-gg9h-rjp7)
- [参考资料](https://github.com/siyuan-note/siyuan/commit/009bb598b3beccc972aa5f1ed88b3b224326bf2a)
- [参考资料](https://nvd.nist.gov/vuln/detail/CVE-2026-33476)
