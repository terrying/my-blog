---
title: 'Nuclei POC 精选分析 - 2026-05-04'
date: '2026-05-04'
tags: ['Nuclei', 'POC分析', '漏洞扫描', '威胁情报']
draft: false
summary: '从 602 个模板更新中精选分析 26 个高价值 POC，发现 17 个高风险漏洞'
authors: ['default']
category: 'security-intel'
---

# Nuclei POC 精选分析 - 2026-05-04
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.07973 (percentile 0.92093) @ 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.53659 (percentile 0.98009) @ 2026-05-03
...
- **影响资产**: GitLab 平台
- **预估影响**: 数千个
- **EPSS**: 0.20843 (percentile 0.95641) @ 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.54011 (percentile 0.98026) @ 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.44456 (percentile 0.9758) @ 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.77758 (percentile 0.99012) @ 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.53057 (percentile 0.97978) @ 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.68973 (percentile 0.98646) @ 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.91812 (percentile 0.99694) @ 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.92118 (percentile 0.99716) @ 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.10607 (percentile 0.93318) @ 2026-05-03
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.01922 (percentile 0.83451) @ 2026-05-03
...
| Essential Addons for Elementor &lt; 6.0.15 - Cross | 🟡 medium | CVE漏洞 | 通用 | 0.0385 | 3.5/5 |
| Swagger UI &gt;&#x3D;3.14.1 &lt; 3.38.0 - DOM Base | 🟡 medium | CVE漏洞 | 通用 | 0.0051 | 3.5/5 |
| Outline Panel - Detect | ⚪ info | 其他 | 管理面板 | - | 1/5 |
| Outline Panel - Detect | ⚪ info | 其他 | 管理面板 | - | 1/5 |
...
```bash
# 扫描高危漏洞
nuclei -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-22457.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32433.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-54309.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-9242.yaml -t code/cves/2026/CVE-2026-24061.yaml -t headless/cves/2025/CVE-2025-29927-HEADLESS.yaml -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-22457.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32433.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2025/CVE-2025-6984.yaml -u target-url

# 扫描所有今日新增模板  
nuclei -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-22457.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32433.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-54309.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-9242.yaml -t code/cves/2026/CVE-2026-24061.yaml -t headless/cves/2025/CVE-2025-29927-HEADLESS.yaml -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-22457.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32433.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2025/CVE-2025-6984.yaml -t headless/cves/2025/CVE-2025-25062.yaml -t headless/cves/2025/CVE-2025-24752.yaml -t headless/cves/2025/CVE-2025-8191.yaml -t headless/cves/2025/CVE-2025-24752.yaml -t headless/cves/2025/CVE-2025-8191.yaml -t http/exposed-panels/outline-panel.yaml -t http/exposed-panels/outline-panel.yaml -t file/logs/aspnet-framework-exceptions.yaml -t file/logs/nodejs-framework-exceptions.yaml -u target-url
```
