---
title: 'Nuclei POC 精选分析 - 2026-08-29'
date: '2026-08-29'
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.02581 (percentile 0.84042) @ 2026-08-28
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.9999 (percentile 0.99984) @ 2026-08-28
...
- **影响资产**: GitLab 平台
- **预估影响**: 数千个
- **EPSS**: 0.2026 (percentile 0.97333) @ 2026-08-28
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.58759 (percentile 0.99061) @ 2026-08-28
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.35127 (percentile 0.98366) @ 2026-08-28
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.31362 (percentile 0.9819) @ 2026-08-28
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.913 (percentile 0.99804) @ 2026-08-28
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.91522 (percentile 0.99807) @ 2026-08-28
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.97878 (percentile 0.99904) @ 2026-08-28
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.99225 (percentile 0.99934) @ 2026-08-28
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.01661 (percentile 0.74578) @ 2026-08-28
...
- **影响资产**: WordPress 站点
- **预估影响**: 数千万个
- **EPSS**: 0.03578 (percentile 0.88571) @ 2026-08-28
...
```bash
# 扫描高危漏洞
nuclei -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-22457.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2025/CVE-2025-9242.yaml -t code/cves/2026/CVE-2026-20182.yaml -t code/cves/2026/CVE-2026-24061.yaml -t headless/cves/2025/CVE-2025-29927-HEADLESS.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -u target-url

# 扫描所有今日新增模板  
nuclei -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-22457.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2025/CVE-2025-9242.yaml -t code/cves/2026/CVE-2026-20182.yaml -t code/cves/2026/CVE-2026-24061.yaml -t headless/cves/2025/CVE-2025-29927-HEADLESS.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -t headless/cves/2025/CVE-2025-24752.yaml -t headless/cves/2025/CVE-2025-25062.yaml -t headless/cves/2025/CVE-2025-8191.yaml -u target-url
```
