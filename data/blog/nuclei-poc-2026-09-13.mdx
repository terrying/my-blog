---
title: 'Nuclei POC 精选分析 - 2026-09-13'
date: '2026-09-13'
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.02626 (percentile 0.84628) @ 2026-09-12
...
- **影响资产**: GitLab 平台
- **预估影响**: 数千个
- **EPSS**: 0.20586 (percentile 0.97371) @ 2026-09-12
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.98754 (percentile 0.99924) @ 2026-09-12
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.59417 (percentile 0.99065) @ 2026-09-12
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.38527 (percentile 0.98487) @ 2026-09-12
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.31138 (percentile 0.98164) @ 2026-09-12
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.02111 (percentile 0.80754) @ 2026-09-12
...
- **影响资产**: 未知
- **预估影响**: 数千个
- **EPSS**: 0.01647 (percentile 0.75122) @ 2026-09-12
...
- **影响资产**: WordPress 站点
- **预估影响**: 数千万个
- **EPSS**: 0.03578 (percentile 0.88728) @ 2026-09-12
...
```bash
# 扫描高危漏洞
nuclei -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32433.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2026/CVE-2026-8467.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -u target-url

# 扫描所有今日新增模板  
nuclei -t code/cves/2025/CVE-2025-1550.yaml -t code/cves/2025/CVE-2025-25291.yaml -t code/cves/2025/CVE-2025-32433.yaml -t code/cves/2025/CVE-2025-32463.yaml -t code/cves/2025/CVE-2025-6216.yaml -t code/cves/2025/CVE-2025-68926.yaml -t code/cves/2026/CVE-2026-8467.yaml -t code/cves/2025/CVE-2025-6984.yaml -t code/cves/2026/CVE-2026-10795.yaml -t headless/cves/2025/CVE-2025-24752.yaml -t headless/cves/2025/CVE-2025-25062.yaml -t headless/cves/2025/CVE-2025-8191.yaml -u target-url
```
